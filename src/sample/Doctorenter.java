...
public class Doctorenter {
    ...
    public Label nurse11;
    public Label describe2;
    public Label another2;
    public Button visit;

    public void setidcodedoctor(String idcode) {
        try {
            String n ;
            String m ;
            String l;
            m = "doctor idcode:" + idcode;
    ...
    public void visit(ActionEvent actionEvent) throws IOException {
        ...
        Parent root;
        root = FXMLLoader.load(getClass().getResource("visitdoctor.fxml"));
        primaryStage.setTitle("visit");
        primaryStage.setScene(new Scene(root, 600, 523));
        primaryStage.show();
    }
}